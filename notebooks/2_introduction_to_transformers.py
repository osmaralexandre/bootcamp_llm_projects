...
text_generator = pipeline(task="text-generation", model="pierreguillou/gpt2-small-portuguese")
...
qa = pipeline(task="question-answering", model="pierreguillou/bert-base-cased-squad-v1.1-portuguese")
